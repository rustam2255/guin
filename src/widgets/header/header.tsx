      ...
      <div className="relative shrink-0" ref={dropdownRef}>
        ...
        {open && (
          ...
          >
            <div
              className="
                flex items-center gap-3 border-b border-gray-100 pb-4
                2xl:gap-4 2xl:pb-5
              "
            >
              <img
              ...
              <div className="min-w-0">
                ...
                <p
                  className="
                    ...
                    text-sm
                    2xl:text-[15px]
                    min-[1800px]:text-[16px]
                    min-[2200px]:text-[17px]
                  "
                >
                  {roleText}
                </p>
            ...
            <div className="mt-4 space-y-3 2xl:mt-5 2xl:space-y-4">
              <div
                className="
                  flex items-start gap-3 rounded-xl bg-gray-50 px-3 py-3
                  2xl:gap-4 2xl:px-4 2xl:py-4
                "
              >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    className="
                      break-words font-medium text-gray-900
                      text-sm
                      lg:text-[15px]
                      2xl:text-[17px]
                      min-[1800px]:text-[18px]
